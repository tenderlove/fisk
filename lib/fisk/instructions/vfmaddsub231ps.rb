...
class Fisk
  module Instructions
    # Instruction VFMADDSUB231PS: Fused Multiply-Alternating Add/Subtract of Packed Single-Precision Floating-Point Values
    VFMADDSUB231PS = Instruction.new("VFMADDSUB231PS", [
