...
class Fisk
  module Instructions
    # Instruction VCVTUQQ2PS: Convert Packed Unsigned Quadword Integers to Packed Single-Precision Floating-Point Values
    VCVTUQQ2PS = Instruction.new("VCVTUQQ2PS", [
