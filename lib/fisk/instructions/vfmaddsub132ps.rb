...
class Fisk
  module Instructions
    # Instruction VFMADDSUB132PS: Fused Multiply-Alternating Add/Subtract of Packed Single-Precision Floating-Point Values
    VFMADDSUB132PS = Instruction.new("VFMADDSUB132PS", [
