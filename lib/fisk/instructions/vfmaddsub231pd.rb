...
class Fisk
  module Instructions
    # Instruction VFMADDSUB231PD: Fused Multiply-Alternating Add/Subtract of Packed Double-Precision Floating-Point Values
    VFMADDSUB231PD = Instruction.new("VFMADDSUB231PD", [
