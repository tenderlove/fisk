...
class Fisk
  module Instructions
    # Instruction VCVTPS2UQQ: Convert Packed Single Precision Floating-Point Values to Packed Unsigned Quadword Integer Values
    VCVTPS2UQQ = Instruction.new("VCVTPS2UQQ", [
