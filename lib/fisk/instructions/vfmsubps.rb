...
class Fisk
  module Instructions
    # Instruction VFMSUBPS: Fused Multiply-Subtract of Packed Single-Precision Floating-Point Values
    VFMSUBPS = Instruction.new("VFMSUBPS", [
