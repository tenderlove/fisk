...
class Fisk
  module Instructions
    # Instruction VCVTTPD2UQQ: Convert with Truncation Packed Double-Precision Floating-Point Values to Packed Unsigned Quadword Integers
    VCVTTPD2UQQ = Instruction.new("VCVTTPD2UQQ", [
