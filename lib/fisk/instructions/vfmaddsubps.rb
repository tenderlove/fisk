...
class Fisk
  module Instructions
    # Instruction VFMADDSUBPS: Fused Multiply-Alternating Add/Subtract of Packed Single-Precision Floating-Point Values
    VFMADDSUBPS = Instruction.new("VFMADDSUBPS", [
