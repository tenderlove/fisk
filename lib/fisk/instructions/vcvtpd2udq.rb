...
class Fisk
  module Instructions
    # Instruction VCVTPD2UDQ: Convert Packed Double-Precision Floating-Point Values to Packed Unsigned Doubleword Integers
    VCVTPD2UDQ = Instruction.new("VCVTPD2UDQ", [
