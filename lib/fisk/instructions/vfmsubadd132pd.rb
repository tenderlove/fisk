...
class Fisk
  module Instructions
    # Instruction VFMSUBADD132PD: Fused Multiply-Alternating Subtract/Add of Packed Double-Precision Floating-Point Values
    VFMSUBADD132PD = Instruction.new("VFMSUBADD132PD", [
