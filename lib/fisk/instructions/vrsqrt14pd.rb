...
class Fisk
  module Instructions
    # Instruction VRSQRT14PD: Compute Approximate Reciprocals of Square Roots of Packed Double-Precision Floating-Point Values
    VRSQRT14PD = Instruction.new("VRSQRT14PD", [
