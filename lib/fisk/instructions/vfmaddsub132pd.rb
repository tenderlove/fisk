...
class Fisk
  module Instructions
    # Instruction VFMADDSUB132PD: Fused Multiply-Alternating Add/Subtract of Packed Double-Precision Floating-Point Values
    VFMADDSUB132PD = Instruction.new("VFMADDSUB132PD", [
