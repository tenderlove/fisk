...
class Fisk
  module Instructions
    # Instruction VFMSUBADD132PS: Fused Multiply-Alternating Subtract/Add of Packed Single-Precision Floating-Point Values
    VFMSUBADD132PS = Instruction.new("VFMSUBADD132PS", [
