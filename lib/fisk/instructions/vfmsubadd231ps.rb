...
class Fisk
  module Instructions
    # Instruction VFMSUBADD231PS: Fused Multiply-Alternating Subtract/Add of Packed Single-Precision Floating-Point Values
    VFMSUBADD231PS = Instruction.new("VFMSUBADD231PS", [
