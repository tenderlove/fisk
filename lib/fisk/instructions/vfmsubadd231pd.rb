...
class Fisk
  module Instructions
    # Instruction VFMSUBADD231PD: Fused Multiply-Alternating Subtract/Add of Packed Double-Precision Floating-Point Values
    VFMSUBADD231PD = Instruction.new("VFMSUBADD231PD", [
