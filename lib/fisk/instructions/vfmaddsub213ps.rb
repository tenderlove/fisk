...
class Fisk
  module Instructions
    # Instruction VFMADDSUB213PS: Fused Multiply-Alternating Add/Subtract of Packed Single-Precision Floating-Point Values
    VFMADDSUB213PS = Instruction.new("VFMADDSUB213PS", [
